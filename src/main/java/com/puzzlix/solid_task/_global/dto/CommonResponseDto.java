...
//    private CommonResponseDto(boolean success, TabularData,String message) {
...
//    }
    ...
    // static는 객체 속성이 아니라 클래스에 포함 - ClassName.add();
     ...
     */
    // 객체 생성을 원한다면 메서드를 통해서 생성해야함
    // new CommonResponseDto(); <- private 생성자<
    // CommonResponseDto.error("잘못된 비밀번호 입니다.")
}
